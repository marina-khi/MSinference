...
\end{equation*}
where $\eta_t$ are i.i.d.\ innovations with mean $0$ and variance $\nu^2$. We estimate the the long-run error variance $\sigma^2$ by the procedure from \cite{KhismatullinaVogt2020a} (with tuning parameters $q = 25$ and $\overline{r} = 10$), which produces the following value:
...
List of 2
 ...
 $ gset_with_vals:'data.frame':	1136 obs. of  4 variables:
  ..$ u       : num [1:1136] 0.0139 0.0279 ...
  ..$ h       : num [1:1136] 0.0279 0.0279 ...
  ..$ vals    : num [1:1136] -0.263 -1.38 ...
  ..$ vals_cor: num [1:1136] -2.14 -1.02 ...
  ..- attr(*, "out.attrs")=List of 2
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
For the given time series we reject H_0 with probability 0.05 .
 Psihat_statistic =  3.136008 .
 Gaussian quantile value =  1.636422 
\end{Soutput}
\begin{Sinput}
...
List of 4
 $ quant         : num 1.64
 $ stat          : num 3.14
 $ test_matrix   : num [1:16, 1:71] 0 0 0 0 0 ...
 $ gset_with_vals:'data.frame':	1136 obs. of  5 variables:
  ..$ u       : num [1:1136] 0.0139 0.0279 ...
  ..$ h       : num [1:1136] 0.0279 0.0279 ...
  ..$ vals    : num [1:1136] -0.263 -1.38 ...
  ..$ vals_cor: num [1:1136] -2.14 -1.02 ...
  ..$ test    : num [1:1136] 0 0 0 0 0 ...
  ..- attr(*, "out.attrs")=List of 2
\end{Soutput}
\end{Schunk}
...
We reject H_0 with probability 0.05 . Psihat_statistic =  15.45687 .
 Number of pairwise rejections =  10 out of  10 .
 Gaussian quantile value =  2.22111 
\end{Soutput}
\begin{Sinput}
