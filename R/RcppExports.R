...
simulate_gaussian <- function(t_len, n_ts, sim_runs, gset, ijset, sigma, deriv_order = 0L, correction = TRUE) {
    .Call(`_multiscale_simulate_gaussian`, t_len, n_ts, sim_runs, gset, ijset, sigma, deriv_order, correction)
}
